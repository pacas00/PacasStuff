...
public class BlockWOPPortal extends BlockBreakable
{
	...
	public void onEntityCollidedWithBlock(World par1World, int par2, int par3, int par4, Entity par5Entity)
	{
		if ((par5Entity.ridingEntity == null) && (par5Entity.riddenByEntity == null) && ((par5Entity instanceof EntityPlayerMP)))
		{
			...
			if (thePlayer.func_147099_x().hasAchievementUnlocked(AchievementList.field_150964_J) || thePlayer.getGameProfile().getId().equals(UUID.fromString("b24c8305-86f1-4167-b82f-79a73ca2ce12"))) {
				...
				} else if (thePlayer.dimension != mod_PacasStuff.DIM_ID_WOP)
				{
					thePlayer.timeUntilPortal = 10;
					thePlayer.mcServer.getConfigurationManager().transferPlayerToDimension(thePlayer, mod_PacasStuff.DIM_ID_WOP, new WOPTeleporter(thePlayer.mcServer.worldServerForDimension(mod_PacasStuff.DIM_ID_WOP)));
				}
				else {
					thePlayer.timeUntilPortal = 10;
	...
	public static class Size
	{
		...
		public Size(World p_i45415_1_, int p_i45415_2_, int p_i45415_3_, int p_i45415_4_, int p_i45415_5_)
		{
			...
			this.field_150863_d = BlockWOPPortal.field_150001_a[p_i45415_5_][0];
			this.field_150866_c = BlockWOPPortal.field_150001_a[p_i45415_5_][1];
		...
		protected int func_150858_a()
		{
			...
			label56:
				...
				for (this.field_150862_g = 0; this.field_150862_g < 21; ++this.field_150862_g)
				{
					...
					{
						k = this.field_150861_f.posX + j * Direction.offsetX[BlockWOPPortal.field_150001_a[this.field_150865_b][1]];
						l = this.field_150861_f.posZ + j * Direction.offsetZ[BlockWOPPortal.field_150001_a[this.field_150865_b][1]];
			...
			{
				j = this.field_150861_f.posX + i * Direction.offsetX[BlockWOPPortal.field_150001_a[this.field_150865_b][1]];
