...
public class WOPBiomeDecorator extends BiomeDecorator {
	...
	protected void genDecorations(BiomeGenBase p_150513_1_)
	{
		...
		if (doGen && this.generateLakes)
		{
			...
			if (Loader.isModLoaded("ThermalFoundation")) {
				...
				if (FluidRegistry.isFluidRegistered("redstone") && r.nextInt(100) < 4) {
					Block fluid = FluidRegistry.getFluid("redstone").getBlock();

					k = this.chunk_X + this.randomGenerator.nextInt(16) + 8;
					l = this.randomGenerator.nextInt(this.randomGenerator.nextInt(248) + 8);
					i1 = this.chunk_Z + this.randomGenerator.nextInt(16) + 8;
					(new WorldGenLakes(fluid)).generate(this.currentWorld, this.randomGenerator, k, l, i1);
			...
			if (Loader.isModLoaded("ThermalFoundation")) {
				if (FluidRegistry.isFluidRegistered("cryotheum") && r.nextInt(100) < 2) {
					Block fluid = FluidRegistry.getFluid("cryotheum").getBlock();
			...
			if (Loader.isModLoaded("ThermalFoundation")) {
				if (FluidRegistry.isFluidRegistered("pyrotheum") && r.nextInt(100) < 2) {
					Block fluid = FluidRegistry.getFluid("pyrotheum").getBlock();
			...
			if (Loader.isModLoaded("ThermalFoundation")) {
				if (FluidRegistry.isFluidRegistered("ender") && r.nextInt(100) < 4) {
					Block fluid = FluidRegistry.getFluid("ender").getBlock();
	...
	protected void generateOres()
	{
		...
		if (TerrainGen.generateOre(currentWorld, randomGenerator, goldGen, chunk_X, chunk_Z, GOLD))
			this.genStandardOre1(4, this.goldGen, 0, 32);
		this.genStandardOre1(2, this.goldGen, 24, 48);
		this.genStandardOre1(2, this.goldGen, 33, 64);
		if (TerrainGen.generateOre(currentWorld, randomGenerator, redstoneGen, chunk_X, chunk_Z, REDSTONE))
			this.genStandardOre1(8, this.redstoneGen, 0, 16);
		this.genStandardOre1(4, this.redstoneGen, 17, 64);
		if (TerrainGen.generateOre(currentWorld, randomGenerator, diamondGen, chunk_X, chunk_Z, DIAMOND))
			this.genStandardOre1(3, this.diamondGen, 0, 16);
		this.genStandardOre1(2, this.diamondGen, 17, 32);
		this.genStandardOre1(1, this.diamondGen, 33, 64);
		if (TerrainGen.generateOre(currentWorld, randomGenerator, lapisGen, chunk_X, chunk_Z, LAPIS))
			this.genStandardOre2(2, this.lapisGen, 16, 16);
