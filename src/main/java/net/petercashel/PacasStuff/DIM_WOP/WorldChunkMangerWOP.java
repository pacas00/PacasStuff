...
public class WorldChunkMangerWOP extends WorldChunkManager {
	...
	protected WorldChunkMangerWOP()
	{
		this.myBiomeCache = new BiomeCache(this);
		this.myBiomesToSpawnIn = new ArrayList<BiomeGenBase>();
		this.myBiomesToSpawnIn.add(mod_PacasStuff.WOP);
	}

	public WorldChunkMangerWOP(long seed, WorldType worldtype)
	{
		this();
	...
	public WorldChunkMangerWOP(World world)
	{
	...
	public BiomeGenBase[] getBiomesForGeneration(BiomeGenBase[] par1ArrayOfBiomeGenBase, int par2, int par3, int par4, int par5) {
		...
		for (int i = 0; i < par4 * par5; ++i) {
			if (aint[i] >= 0) {
				...
				par1ArrayOfBiomeGenBase[i] = mod_PacasStuff.WOP;
			}
		}
