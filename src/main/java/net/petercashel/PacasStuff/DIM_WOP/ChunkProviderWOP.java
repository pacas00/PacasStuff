...
public class ChunkProviderWOP implements IChunkProvider {
    ...
    public ChunkProviderWOP(World p_i2006_1_, long p_i2006_2_, boolean p_i2006_4_)
    {
                            ...
                            for (int k3 = 0; k3 < 4; ++k3)
                            {
                                ...
                                else if (k2 * 8 + l2 < b0)
                                {
                                	...
                                	if (Loader.isModLoaded("IC2")) {
                        				if (FluidRegistry.isFluidRegistered("ic2uumatter")) {
                        					water = FluidRegistry.getFluid("ic2uumatter").getBlock();
                        				} else {
                        					if (Loader.isModLoaded("ThermalFoundation")) {

                        						if (FluidRegistry.isFluidRegistered("redstone")) {
                        							water = FluidRegistry.getFluid("redstone").getBlock();
                        						}

                        					}
                        				}
                        			}
                                    p_147424_3_[j3 += short1] = water;
                                }
                                else
                                {
