...
public class WorldGenMinableModded extends WorldGenMinable {
    ...
    public WorldGenMinableModded(Block p_i45459_1_, int p_i45459_2_)
    {
        this(p_i45459_1_, p_i45459_2_, Blocks.stone);
    }

    public WorldGenMinableModded(Block p_i45460_1_, int p_i45460_2_, Block p_i45460_3_)
    {
    ...
    public WorldGenMinableModded(Block block, int meta, int number, Block target)
    {
                    ...
                    for (int l2 = j1; l2 <= i2; ++l2)
                    {
                        ...
                        if (d12 * d12 + d13 * d13 < 1.0D)
                        {
                            for (int i3 = k1; i3 <= j2; ++i3)
                            {
                                ...
                                if (d12 * d12 + d13 * d13 + d14 * d14 < 1.0D && BiomeGenWOP.blkRandom.contains(p_76484_1_.getBlock(k2, l2, i3)))
                                {
                                	p_76484_1_.setBlock(k2, l2, i3, this.field_150519_a, mineableBlockMeta, 2);
                                }
                            }
