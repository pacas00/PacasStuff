...
public class PacasDimensionWorldGenTree extends WorldGenTrees {
	...
	public PacasDimensionWorldGenTree(boolean par1) {
		this(par1, 10, 0, 0, false);
	}

	public PacasDimensionWorldGenTree(boolean par1, int par2, int par3, int par4, boolean par5) {
		super(par1);
			...
			if (!var7) {
				...
				if ((var8 == var8B.getIdFromBlock(Blocks.grass) || var8 == var8B.getIdFromBlock(Blocks.dirt)) && par4 < 256 - var6 - 1) {
					...
					for (var11 = 0; var11 < var6; ++var11) {
						var12 = var8B.getIdFromBlock(par1World.getBlock(par3, par4 + var11, par5));
