...
public class BlockRedlandsPortal extends BlockBreakable
{
	...
	public void onNeighborBlockChange(World p_149695_1_, int p_149695_2_, int p_149695_3_, int p_149695_4_, Block p_149695_5_)
	{
		...
		BlockRedlandsPortal.Size size = new BlockRedlandsPortal.Size(p_149695_1_, p_149695_2_, p_149695_3_, p_149695_4_, 1);
		BlockRedlandsPortal.Size size1 = new BlockRedlandsPortal.Size(p_149695_1_, p_149695_2_, p_149695_3_, p_149695_4_, 2);
	...
	public static class Size
	{
		...
		protected int func_150853_a(int p_150853_1_, int p_150853_2_, int p_150853_3_, int p_150853_4_)
		{
			...
			for (i1 = 0; i1 < 22; ++i1)
			{
				...
				if (block1 != mod_PacasStuff.RedlandsPortalFrame)
				{
					break;
				}
			}
			...
			block = this.field_150867_a.getBlock(p_150853_1_ + j1 * i1, p_150853_2_, p_150853_3_ + k1 * i1);
			return block == mod_PacasStuff.RedlandsPortalFrame ? i1 : 0;
		}
		...
		protected int func_150858_a()
		{
			...
			label56:
				...
				for (this.field_150862_g = 0; this.field_150862_g < 21; ++this.field_150862_g)
				{
					...
					for (j = 0; j < this.field_150868_h; ++j)
					{
						...
						if (block == mod_PacasStuff.RedlandsPortal)
						{
							++this.field_150864_e;
						}
						...
						if (j == 0)
						{
							...
							if (block != mod_PacasStuff.RedlandsPortalFrame)
							{
								break label56;
							}
						}
			...
			for (i = 0; i < this.field_150868_h; ++i)
			{
				...
				if (this.field_150867_a.getBlock(j, k, l) != mod_PacasStuff.RedlandsPortalFrame)
				{
		...
		public void func_150859_c()
		{
			for (int i = 0; i < this.field_150868_h; ++i)
			{
				...
				for (int l = 0; l < this.field_150862_g; ++l)
				{
					...
					this.field_150867_a.setBlock(j, i1, k, mod_PacasStuff.RedlandsPortal, this.field_150865_b, 2);
				}
			}
		}
	}
