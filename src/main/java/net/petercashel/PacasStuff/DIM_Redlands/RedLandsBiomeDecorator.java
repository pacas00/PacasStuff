...
public class RedLandsBiomeDecorator extends BiomeDecorator {
    ...
    public RedLandsBiomeDecorator()
    {
        ...
        this.goldGen = new WorldGenMinable(Blocks.gold_ore, 24);
        this.redstoneGen = new WorldGenMinable(Blocks.redstone_ore, 24);
        this.diamondGen = new WorldGenMinable(Blocks.diamond_ore, 24);
        this.lapisGen = new WorldGenMinable(Blocks.lapis_ore, 24);
