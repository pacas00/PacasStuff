...
public class WorldChunkMangerRedlands extends WorldChunkManager {
	...
	protected WorldChunkMangerRedlands()
	{
		this.myBiomeCache = new BiomeCache(this);
		this.myBiomesToSpawnIn = new ArrayList<BiomeGenBase>();
		this.myBiomesToSpawnIn.add(mod_PacasStuff.Redlands);
	}

	public WorldChunkMangerRedlands(long seed, WorldType worldtype)
	{
		this();
	...
	public WorldChunkMangerRedlands(World world)
	{
	...
	public BiomeGenBase getBiomeGenAt(int x, int z)
	{
		...
		if (biome == null)
		{
			return mod_PacasStuff.Redlands;
		}
	...
	public BiomeGenBase[] getBiomesForGeneration(BiomeGenBase[] par1ArrayOfBiomeGenBase, int par2, int par3, int par4, int par5) {
		...
		for (int i = 0; i < par4 * par5; ++i) {
			if (aint[i] >= 0) {
				...
				par1ArrayOfBiomeGenBase[i] = mod_PacasStuff.Redlands;
			}
		}
