...
public class BlockPacChest2 extends BlockContainer
{
	public final int field_149956_a;
	private ItemStack boxItem = new ItemStack(Items.stick, 64);
	private boolean beenSticked = false;

	
	public BlockPacChest2(int p_i45397_1_)
	{
		super(Material.wood);
	...
	public void onBlockPlacedBy(World p_149689_1_, int p_149689_2_, int p_149689_3_, int p_149689_4_, EntityLivingBase p_149689_5_, ItemStack p_149689_6_)
	{
		...
		{
			((TileEntityPacChest2)p_149689_1_.getTileEntity(p_149689_2_, p_149689_3_, p_149689_4_)).func_145976_a(p_149689_6_.getDisplayName());
		}
		//getInventory
	...
	public void onNeighborBlockChange(World p_149695_1_, int p_149695_2_, int p_149695_3_, int p_149695_4_, Block p_149695_5_)
	{
		...
		TileEntityPacChest2 TileEntityPacChest2 = (TileEntityPacChest2)p_149695_1_.getTileEntity(p_149695_2_, p_149695_3_, p_149695_4_);

		if (TileEntityPacChest2 != null)
		{
			TileEntityPacChest2.updateContainingBlockInfo();
		}
	}
		...
		else
		{
			...
			try {
				if (!(p_149727_5_.getHeldItem() == null)) {
					if (beenSticked) {
						boxItem = new ItemStack(p_149727_5_.getHeldItem().getItem(), 64, p_149727_5_.getHeldItem().getItemDamage());
						((TileEntityPacChest2)p_149727_1_.getTileEntity(p_149727_2_, p_149727_3_, p_149727_4_)).setBoxItem(boxItem);
						((TileEntityPacChest2)p_149727_1_.getTileEntity(p_149727_2_, p_149727_3_, p_149727_4_)).func_145976_a("Chest of - " + boxItem.getDisplayName());
						beenSticked = false;
					} else if (new ItemStack(p_149727_5_.getHeldItem().getItem()).isItemEqual(new ItemStack(Items.stick))) {
						beenSticked = true;
						return true;
					}
				}
	...
	{
		Object object = (TileEntityPacChest2)p_149951_1_.getTileEntity(p_149951_2_, p_149951_3_, p_149951_4_);
	...
	public int isProvidingWeakPower(IBlockAccess p_149709_1_, int p_149709_2_, int p_149709_3_, int p_149709_4_, int p_149709_5_)
	{
		...
		{
			int i1 = ((TileEntityPacChest2)p_149709_1_.getTileEntity(p_149709_2_, p_149709_3_, p_149709_4_)).numPlayersUsing;
	...
	private IInventory SetInventory(IInventory inv) {
		...
		if (inv != null)
		{
			for (int i = 0; i < inv.getSizeInventory(); i++) {
				inv.setInventorySlotContents(i, new ItemStack(boxItem.getItem(), 64, boxItem.getItemDamage()));
