...
public class TileEntityPacChest2Renderer extends TileEntitySpecialRenderer
{
    ...
    private static final ResourceLocation field_147505_d = new ResourceLocation("pacas_stuff:textures/entity/bottomlesschest/normal_double.png");
    ...
    private static final ResourceLocation field_147504_g = new ResourceLocation("pacas_stuff:textures/entity/bottomlesschest/normal.png");
    
   // private static final ResourceLocation RES_NORMAL_DOUBLE = new ResourceLocation("pacasore:textures/entity/bottomlesschest/normal_double.png");
   // private static final ResourceLocation RES_NORMAL_SINGLE = new ResourceLocation("pacasore:textures/entity/bottomlesschest/normal.png");
    ...
    public void renderTileEntityAt(TileEntityPacChest2 p_147502_1_, double p_147502_2_, double p_147502_4_, double p_147502_6_, float p_147502_8_)
    {
        int i;
        ...
        else
        {
            ...
            if (block instanceof BlockPacChest2 && i == 0)
            {
                try
                {
                ((BlockPacChest2)block).func_149954_e(p_147502_1_.getWorldObj(), p_147502_1_.xCoord, p_147502_1_.yCoord, p_147502_1_.zCoord);
                }
    ...
    {
        this.renderTileEntityAt((TileEntityPacChest2)p_147500_1_, p_147500_2_, p_147500_4_, p_147500_6_, p_147500_8_);
    }
}