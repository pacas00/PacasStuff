...
public class BlockPacasAnvil_basic extends BlockContainer implements ITileEntityProvider {
	...
	public void registerBlockIcons(IIconRegister iconRegister) {
		this.blockIcon = iconRegister.registerIcon("pacas_stuff:PacasAnvilModel_Basic");
	}
	...
	{
		return new TileEntityPacasAnvil_Basic();
	}
	...
	public TileEntityPacasAnvil_Basic getTile(World par1World, int par2, int par3,
			int par4) {
		TileEntityPacasAnvil_Basic te = (TileEntityPacasAnvil_Basic) par1World.getTileEntity( par2, par3, par4 );
		return te;
	}
