...
/**
 * @author Universal Electricity. Based off of Biomes of Plenty
 */
public class CapeEventHandler
{
	private final String serverLocation = "https://raw.github.com/pacas00/PacasStuff/master/capes/capes.txt";
		...
		try
		{
			...
			while ((str = br.readLine()) != null)
			{
				if (!str.startsWith("--") && !str.isEmpty())
				{
					...
					{
						FMLLog.log("PacasStuff", Level.FATAL, "[capes.txt] Syntax error on line " + linetracker + ": " + str);
					}
				}
				linetracker++;
			}
	...
	private class CloakThread implements Runnable
	{
		...
		public void run()
		{
			...
			{
				FMLLog.log("PacasStuff", Level.WARN, "Failed to load capes");
				e.printStackTrace();
			}
		}
	}
