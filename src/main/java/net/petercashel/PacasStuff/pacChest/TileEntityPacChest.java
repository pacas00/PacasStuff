...
public class TileEntityPacChest extends TileEntity implements IInventory
{
     ...
     */
    public TileEntityPacChest adjacentChestZNeg;
    /**
     * Contains the chest tile located adjacent to this one (if any)
     */
    public TileEntityPacChest adjacentChestXPos;
    /**
     * Contains the chest tile located adjacent to this one (if any)
     */
    public TileEntityPacChest adjacentChestXNeg;
    /**
     * Contains the chest tile located adjacent to this one (if any)
     */
    public TileEntityPacChest adjacentChestZPos;
    /**
    ...
    public TileEntityPacChest()
    {
        this.cachedChestType = -1;
    }

    @SideOnly(Side.CLIENT)
    public TileEntityPacChest(int par1)
    {
    ...
    private void func_145978_a(TileEntityPacChest p_145978_1_, int p_145978_2_)
    {
    ...
    public void checkForAdjacentChests()
    {
        if (!this.adjacentChestChecked)
        {
            ...
            {
                this.adjacentChestXNeg = (TileEntityPacChest)this.worldObj.getTileEntity(this.xCoord - 1, this.yCoord, this.zCoord);
            }

            if (this.func_145977_a(this.xCoord + 1, this.yCoord, this.zCoord))
            {
                this.adjacentChestXPos = (TileEntityPacChest)this.worldObj.getTileEntity(this.xCoord + 1, this.yCoord, this.zCoord);
            }

            if (this.func_145977_a(this.xCoord, this.yCoord, this.zCoord - 1))
            {
                this.adjacentChestZNeg = (TileEntityPacChest)this.worldObj.getTileEntity(this.xCoord, this.yCoord, this.zCoord - 1);
            }

            if (this.func_145977_a(this.xCoord, this.yCoord, this.zCoord + 1))
            {
                this.adjacentChestZPos = (TileEntityPacChest)this.worldObj.getTileEntity(this.xCoord, this.yCoord, this.zCoord + 1);
            }
    ...
    private boolean func_145977_a(int p_145977_1_, int p_145977_2_, int p_145977_3_)
    {
        ...
        return block instanceof BlockPacChest && ((BlockPacChest)block).field_149956_a == this.func_145980_j();
    }
    ...
    {
        if (this.getBlockType() instanceof BlockPacChest)
        {
            --this.numPlayersUsing;
            this.worldObj.addBlockEvent(this.xCoord, this.yCoord, this.zCoord, this.getBlockType(), 1, this.numPlayersUsing);
            this.worldObj.notifyBlocksOfNeighborChange(this.xCoord, this.yCoord, this.zCoord, this.getBlockType());
    ...
    public int func_145980_j()
    {
        ...
        {
            if (this.worldObj == null || !(this.getBlockType() instanceof BlockPacChest))
            {
                return 0;
            }

            this.cachedChestType = ((BlockPacChest)this.getBlockType()).field_149956_a;
        }
